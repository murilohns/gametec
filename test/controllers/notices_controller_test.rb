...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post notices_url, params: { notice: { admin_id: @notice.admin_id, content: @notice.content, title: @notice.title } }
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { admin_id: @notice.admin_id, content: @notice.content, title: @notice.title } }
